...
which_key.add({
    ...
    { "<leader>tw",          function() require("core.terminal").float() end,        desc = "Floating Terminal" },
    { "<leader>tv",          function() require("core.terminal").vsplit() end,       desc = "Vertical Terminal" },
    { "<leader>th",          function() require("core.terminal").hsplit() end,       desc = "Horizontal Terminal" },
